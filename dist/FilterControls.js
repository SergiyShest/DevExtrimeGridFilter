...
//������ ������� �������� ������ � �����
function FilterField(dataGridColumn, input, checkBox) {
                ...
                case 'number':
                    {
                        if (val.includes(',')) {
                            ...
                            filter.push([this.DataField, '=', val]);
                        }
                    }break;
                case 'string':
                    {
                        filter.push([this.DataField, 'contains', val]);
                    }
            }
...
function FilterElements(datagrid, fe) {
    ...
    function FindFilterElementsByDateField(dataField) {
        for (i = 0; i < this.FilterElementsArray.length; i++) {
            if (this.FilterElementsArray[i].DataField == dataField) {
                return this.FilterElementsArray[i];
            }
        }
    }
    //������� �������� �������
    ...
    function SetOldFilter(oldGridFilter) {
        ...
        var first = oldGridFilter[0];
        var condition = oldGridFilter[1];
        var val = oldGridFilter[2];
        if (typeof first === 'string') {
            ...
            oldGridFilter.forEach(function (element) {
                if (typeof element != 'string') {
                    SetOldFilter(element);
                }
            });
        }
    }
